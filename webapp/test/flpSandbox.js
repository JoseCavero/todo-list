		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TODO",
									"targetURL": "#josecaverotodolist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"josecaverotodolist-display": {
								"semanticObject": "josecaverotodolist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=jose.cavero.todolist",
									"url": sap.ui.require.toUrl("jose/cavero/todolist")
								}
							}
						}
					}
